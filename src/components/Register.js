...
const Register = () => {
  return (
    <div class="container my-5 shadow">
      <h1 class="text-center text-primary py-3">新規登録</h1>
      <div class="form-group">
        <label for="username">ユーザ ID:</label>
        <input type="text" class="form-control" id="username" name="username" placeholder="ユーザ　ID"/>
      </div>
      <div class="form-group">
      ...
      <button type="button submit" class="btn btn-success mx-auto d-block">保存</button>
      <p class="mt-3 mb-4 h6">私のページの利用規約とプライバシー規約に同意いただける場合は保存ボータン押ししてください。</p>
    </div>
  );
};
