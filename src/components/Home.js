...
const HOME = () => {
  ...
  const login = () => {
    ...
    axios
      .post("http://localhost:8080/login", item, {
    ...
    <div className=" Home-main container-flued ">
      <div className=" row">
        <div className=" col-6 Home-box1">
          <h1 className=" Home-h1 text-center  text-primary font-weight-bold ">
            ようこそへ
          </h1>
          <h5 className=" h5 text-center pt-3 ">お会いできて嬉しいです！</h5>
          <p className="p text-center font-weight-bold">
            こちらビザ管理システムです。皆のビザの管理もっと簡単になるように！
          </p>
        </div>
        <div className=" col-4 Home-box2 ">
          <div className=" form-group ml-5 mt-3 shadow ">
            <legend className=" Home-title text-center mt-4  text-primary h3 ">
              ログイン
            </legend>
            ...
            <div className=" d-flex justify-content-center">
              <p className=" mt-3 d-inline-block  ">
                パスワード忘れた場合は{" "}
                <Link className="Home-Link" to="/ForgetPass">
                  こちら
                </Link>{" "}
              </p>
            </div>
